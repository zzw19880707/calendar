//
//  SettingDataPresentationController.swift
//  calendar
//
...
class SettingDataPresentationController: UIPresentationController {

    lazy var dimmingView :UIView = {
        var  bgView = UIView(frame: self.containerView!.bounds)
        bgView.backgroundColor = UIColor(red: 0.0, green: 1.0, blue: 0.0, alpha: 0.5)
        bgView.alpha = 0.0
